...
CUT.isEqual("isIndex();", "1100000000000000000000", ""
  + +CEL.isIndex(3) + +CEL.isIndex(0) + +CEL.isIndex("3")
  + +CEL.isIndex(true)
  + +CEL.isIndex(-0)
  + +CEL.isIndex(Infinity) + +CEL.isIndex(-Infinity)
  + +CEL.isIndex("Infinity") + +CEL.isIndex("-Infinity")
  + +CEL.isIndex(-3) + +CEL.isIndex(3.14) + +CEL.isIndex(-3.14)
  + +CEL.isIndex("fasdas")
  + +CEL.isIndex(false)
  + +CEL.isIndex("-3") + +CEL.isIndex("3.14") + +CEL.isIndex("-3.14")
  + +CEL.isIndex("adsasd")
  + +CEL.isIndex({}) + +CEL.isIndex([])
...
CUT.isEqual("toIndex();", "3031021474836470214748364700300003000000", ""
  ...
  + CEL.toIndex(-0)
  + CEL.toIndex(Infinity) + CEL.toIndex(-Infinity)
  + CEL.toIndex("Infinity") + CEL.toIndex("-Infinity")
  + CEL.toIndex(-3) + CEL.toIndex(3.14) + CEL.toIndex(-3.14)
  + CEL.toIndex("fasdas")
  + CEL.toIndex(false)
  + CEL.toIndex("-3") + CEL.toIndex("3.14") + CEL.toIndex("-3.14")
  + CEL.toIndex("adsasd")
...
CUT.isEqual("toLength();", "3031021474836470214748364700300003000000", ""
  ...
  + CEL.toLength(true)
  + CEL.toLength(-0)
  + CEL.toLength(Infinity) + CEL.toLength(-Infinity)
  + CEL.toLength("Infinity") + CEL.toLength("-Infinity")
  + CEL.toLength(-3) + CEL.toLength(3.14) + CEL.toLength(-3.14)
  + CEL.toLength("fasdas")
  + CEL.toLength(false)
  + CEL.toLength("-3") +  CEL.toLength("3.14") +CEL.toLength("-3.14")
  + CEL.toLength("adsasd")
...
CUT.isEqual("toInteger();",
  ...
  + CEL.toInteger(3) + CEL.toInteger("3") + CEL.toInteger(3.14)
  + CEL.toInteger("3.14")
  + CEL.toInteger(-3) + CEL.toInteger(-3.14)
  + CEL.toInteger("-3") + CEL.toInteger("-3.14")
  + CEL.toInteger(true)
  + CEL.toInteger(0) + CEL.toInteger(-0)
  + CEL.toInteger(Infinity) + CEL.toInteger(-Infinity)
  + CEL.toInteger("Infinity") + CEL.toInteger("-Infinity")
  + CEL.toInteger("fasdas")
  + CEL.toInteger(false)
  + CEL.toInteger("adsasd")
  + CEL.toInteger({}) + CEL.toInteger([])
  + CEL.toIndex(undefined) + CEL.toIndex(null)
);
