...
declare const isAsyncIterator: (value: any) => value is AsyncIterator<unknown>;
...
declare const isIterator: <T>(value: any) => value is Iterator<T>;
declare const isRegexp: (value: unknown) => value is RegExp;
declare const isElement: (value: any) => boolean;
declare const isIterable: (value: any) => value is Iterable<any>;
declare const isAsyncIterable: <T>(value: any) => value is AsyncIterable<T>;
...
declare const _default: {
    ...
    isSameInstance: (value1: unknown, value2: unknown, Contructor: Function) => boolean;
    ...
    isIterator: <T>(value: any) => value is Iterator<T>;
