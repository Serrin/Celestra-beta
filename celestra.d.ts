declare const VERSION = "Celestra v7.0.1";
...
declare function _nanoid(size?: number, alphabet?: string): string;
...
declare const compact: (iter: IterableLike) => Iterator<any>;
...
declare function initial(iter: IterableLike): Iterable<any>;
...
declare const last: (iter: IterableLike) => any;
...
declare const _default: {
    ...
    compact: (iter: IterableLike) => Iterator<any>;
    unique: typeof unique;
    count: (iter: IterableLike, callback: Function) => number;
    ...
    first: typeof first;
    head: typeof first;
    last: (iter: IterableLike) => any;
    reverse: typeof reverse;
    sort: ([...array]: any[], numbers?: boolean) => any[];
    includes: typeof includes;
    findLast: (iter: IterableLike, callback: Function) => unknown;
