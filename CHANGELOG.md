...
6. Replace the function `extend();` with `deepAssign();`.
7. Deprecate _(stability 1)_ these functions: `getUrlVars();`, `obj2string();`
8. Remove these functions: `createPolyfillMethod();`, `createPolyfillProperty();`
