...
declare function assertIsNotNil(value: unknown, message?: any): {};
declare function assertIsNil(value: unknown, message?: any): any;
...
declare const strFromCodePoints: ([...array]: any[]) => string;
...
declare function domCreate(elType: string | {
    [key: string]: any;
}, properties: object, innerHTML: string): HTMLElement;
declare function domToElement(str: string): Element | null;
declare const domGetCSS: (el: Element, property: string | number) => string | CSSStyleDeclaration;
declare function domSetCSS(el: HTMLElement, property: string | object, value: string): void;
declare function domFadeIn(el: HTMLElement, duration: number, display: string): void;
declare function domFadeOut(el: HTMLElement, duration: number): void;
declare function domFadeToggle(el: HTMLElement, duration: number, display?: string): void;
declare const domHide: (el: HTMLElement) => any;
declare const domShow: (el: HTMLElement, display?: string) => any;
declare function domToggle(el: HTMLElement, display?: string): void;
declare const domIsHidden: (el: Element) => boolean;
declare const domSiblings: (el: Element) => Element[];
declare const domSiblingsPrev: (el: Element) => Element[];
declare const domSiblingsLeft: (el: Element) => Element[];
declare const domSiblingsNext: (el: Element) => Element[];
declare const domSiblingsRight: (el: HTMLElement) => Element[];
...
declare function setFullscreenOn(el: HTMLElement | string): void;
...
declare const domScrollToElement: (el: Element, top?: boolean) => void;
declare const domClear: (el: Element) => void;
...
declare function compact<T>(iter: Iterable<any> | Iterator<any> | ArrayLike<T>): T[];
declare function unique(iter: Iterable<any> | Iterator<any>, resolver?: string | Function | null | undefined): any[] | void;
declare function count(iter: Iterable<any> | Iterator<any>, fn: Function): number;
declare function arrayDeepClone([...array]: any[]): any[];
declare const initial: ([...array]: any[]) => any[];
declare function shuffle([...array]: any[]): any[];
declare const partition: ([...array]: any[], fn: Function) => any[];
declare const setUnion: (...args: any[]) => Set<any>;
declare const setIntersection: ([...array]: any[], b: Set<any>) => Set<any>;
declare const setDifference: ([...array]: any[], b: Set<any>) => Set<any>;
declare const setSymmetricDifference: (array: Set<any>, b: Set<any>) => Set<any>;
declare const isSuperset: ([...superSet]: any[], [...subSet]: any[]) => boolean;
declare const min: (...args: any[]) => any;
declare const max: (...args: any[]) => any;
declare const arrayRepeat: (value: unknown, n?: number) => any[];
declare const arrayCycle: ([...array]: any[], n?: number) => any[];
...
declare function zipObj([...array1]: any[], [...array2]: any[]): {
    [key: string]: any;
};
...
declare function iterRange(start?: number, step?: number, end?: number): Iterator<any>;
declare function iterCycle([...array]: any[], n?: number): Iterator<any>;
declare function iterRepeat(value: unknown, n?: number): Iterator<any>;
declare function takeWhile(iter: Iterable<any> | Iterator<any>, fn: Function): Iterator<any>;
declare function dropWhile(iter: Iterable<any> | Iterator<any>, fn: Function): Iterator<any>;
declare function take(iter: Iterable<any> | Iterator<any>, n?: number): Iterator<any>;
declare function drop(iter: Iterable<any> | Iterator<any>, n?: number): Iterator<any>;
declare function forEach(iter: Iterable<any> | Iterator<any>, fn: Function): void;
declare function forEachRight([...array]: any[], fn: Function): void;
declare function map(iter: Iterable<any> | Iterator<any>, fn: Function): Iterator<any>;
declare function filter(iter: Iterable<any> | Iterator<any>, fn: Function): Iterator<any>;
declare function reject(iter: Iterable<any> | Iterator<any>, fn: Function): Iterator<any>;
declare function slice(iter: Iterable<any> | Iterator<any>, begin?: number, end?: number): Iterator<any>;
declare function tail(iter: Iterable<any> | Iterator<any>): Iterator<any>;
declare function item(iter: Iterable<any> | Iterator<any>, pos: number): any;
declare function nth(iter: Iterable<any> | Iterator<any>, pos: number): any;
declare function size(iter: Iterable<any> | Iterator<any>): number;
declare function first(iter: Iterable<any> | Iterator<any>): any;
declare function head(iter: Iterable<any> | Iterator<any>): any;
declare const last: ([...array]: any[]) => any;
declare function reverse([...array]: any[]): Iterator<any>;
declare const sort: ([...array]: Iterable<any>, numbers: boolean) => any[];
declare function includes(collection: any, value: unknown, comparator?: Function): boolean;
declare function find(iter: Iterable<any> | Iterator<any>, fn: Function): any;
declare function findLast(iter: Iterable<any> | Iterator<any>, fn: Function): any;
declare function every(iter: Iterable<any> | Iterator<any>, fn: Function): boolean;
declare function some(iter: Iterable<any> | Iterator<any>, fn: Function): boolean;
declare function none(iter: Iterable<any> | Iterator<any>, fn: Function): boolean;
declare const takeRight: ([...array]: any[], n?: number) => any[];
declare function takeRightWhile([...array]: any[], fn: Function): Iterator<any>;
declare const dropRight: ([...array]: any[], n?: number) => any[];
declare function dropRightWhile([...array]: any[], fn: Function): Iterator<any>;
declare function concat(...args: any[]): Iterator<any>;
...
declare const sum: (...values: any[]) => any;
...
declare const _default: {
    ...
    sort: ([...array]: Iterable<any>, numbers: boolean) => any[];
