...
declare function quotient(dividend: number, divisor: number): number;
declare function quotient(dividend: bigint, divisor: bigint): bigint;
declare function remainder(dividend: number, divisor: number): number;
declare function remainder(dividend: bigint, divisor: bigint): bigint;
