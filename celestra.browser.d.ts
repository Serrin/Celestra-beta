...
declare const b64Encode: (str: any) => string;
declare const b64Decode: (str: any) => string;
...
declare function slice(iter: IterableLike, begin?: number, end?: number): GeneratorLike;
declare function tail(iter: IterableLike): GeneratorLike;
...
declare const sort: ([...array]: any[], numbers?: boolean) => any[];
...
declare const _default: {
    ...
    b64Encode: (str: any) => string;
    b64Decode: (str: any) => string;
    ...
    domSiblingsLeft: typeof domSiblingsPrev;
    domSiblingsNext: typeof domSiblingsNext;
    domSiblingsRight: typeof domSiblingsNext;
    ...
    sort: ([...array]: any[], numbers?: boolean) => any[];
