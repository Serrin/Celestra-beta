...
declare const gt: <T extends Comparable>(value1: T, value2: T) => boolean;
declare const gte: <T extends Comparable>(value1: T, value2: T) => boolean;
declare const lt: <T extends Comparable>(value1: T, value2: T) => boolean;
declare const lte: <T extends Comparable>(value1: T, value2: T) => boolean;
...
declare const _default: {
    ...
    gt: <T extends Comparable>(value1: T, value2: T) => boolean;
    gte: <T extends Comparable>(value1: T, value2: T) => boolean;
    lt: <T extends Comparable>(value1: T, value2: T) => boolean;
    lte: <T extends Comparable>(value1: T, value2: T) => boolean;
    tap: typeof tap;
    once: typeof once;
    curry: typeof curry;
