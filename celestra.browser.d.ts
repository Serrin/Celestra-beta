declare const VERSION = "Celestra v6.6.0 browser";
...
type IteratorReturn = Iterable<any> | Iterator<any> | Generator<any, void, unknown>;
...
declare function tap(callback: Function): any;
...
declare const typeOf: (value: unknown) => "null" | "undefined" | "number" | "bigint" | "boolean" | "string" | "symbol" | "object" | "function";
...
declare function zipObj([...array1]: any[], [...array2]: any[]): MapLike;
...
declare function iterCycle([...array]: any[], num?: number): IteratorReturn;
declare function iterRepeat(value: unknown, num?: number): IteratorReturn;
declare function takeWhile<T>(iter: IterableLike, callback: Function): IteratorReturn;
declare function dropWhile<T>(iter: IterableLike, callback: Function): IteratorReturn;
declare function take<T>(iter: IterableLike, num?: number): IteratorReturn;
declare function drop<T>(iter: IterableLike, num?: number): IteratorReturn;
...
declare function map(iter: IterableLike, callback: Function): IteratorReturn;
declare function filter(iter: IterableLike, callback: Function): IteratorReturn;
declare function reject(iter: IterableLike, callback: Function): IteratorReturn;
declare function slice<T>(iter: IterableLike, begin?: number, end?: number): IteratorReturn;
declare function tail<T>(input: IterableLike): IteratorReturn;
...
declare function reverse([...array]: any[]): IteratorReturn;
...
declare function takeRightWhile([...array]: any[], callback: Function): IteratorReturn;
declare const dropRight: ([...array]: any[], num?: number) => any[];
declare function dropRightWhile([...array]: any[], callback: Function): IteratorReturn;
...
declare const isBigUInt64: (value: unknown | NumberLike) => boolean;
declare const toFloat16: (value: unknown) => number;
declare const isFloat16: (value: unknown | NumberLike) => boolean;
declare const signbit: (value: unknown | NumberLike) => boolean;
...
declare const _default: {
    ...
    typeOf: (value: unknown) => "null" | "undefined" | "number" | "bigint" | "boolean" | "string" | "symbol" | "object" | "function";
    ...
    isBigUInt64: (value: unknown | NumberLike) => boolean;
    toFloat16: (value: unknown) => number;
    isFloat16: (value: unknown | NumberLike) => boolean;
    signbit: (value: unknown | NumberLike) => boolean;
