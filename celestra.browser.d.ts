declare const VERSION = "Celestra v6.9.0 browser";
...
declare const _default: {
    ...
    constructorOf: (value: unknown) => Function | undefined;
    ...
    isSameType: (value1: unknown, value2: unknown, type?: string) => boolean;
