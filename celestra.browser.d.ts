declare const VERSION = "Celestra v6.7.1 browser";
...
declare function deepAssign<T extends object, U extends object>(target: T, source: U): T & U;
declare function deepAssign<T extends object, U extends object, V extends object>(target: T, s1: U, s2: V): T & U & V;
declare function deepAssign<T extends object>(target: T, ...sources: any[]): T;
declare function deepAssign<T extends object>(target: T, ...sources: any[]): T;
declare function deepAssign(target: object, ...sources: any[]): object;
...
declare function domSiblingsLeft(element: Element): Element[];
declare function domSiblingsNext(element: Element): Element[];
declare function domSiblingsRight(element: Element): Element[];
...
declare const partition: ([...array]: any[], callback: (value: any, index: number, obj: any[]) => unknown) => any[];
...
declare function arrayRemoveBy(array: any[], callback: (value: any, index: number, obj: any[]) => unknown, all?: boolean): boolean;
...
declare const _default: {
    ...
    qs: (str: string, context?: Document | HTMLElement) => HTMLElement | null;
    domReady: typeof domReady;
    domCreate: typeof domCreate;
    domToElement: typeof domToElement;
    domGetCSS: (element: HTMLElement, property: string | number) => string | CSSStyleDeclaration;
    ...
    domIsHidden: (element: HTMLElement) => boolean;
    domSiblings: typeof domSiblings;
    domSiblingsPrev: typeof domSiblingsPrev;
    domSiblingsLeft: typeof domSiblingsLeft;
    domSiblingsNext: typeof domSiblingsNext;
    domSiblingsRight: typeof domSiblingsRight;
    ...
    getFullscreen: () => Document | Element | undefined;
    ...
    domScrollToElement: (element: HTMLElement, top?: boolean) => void;
    ...
    partition: ([...array]: any[], callback: (value: any, index: number, obj: any[]) => unknown) => any[];
    min: (...args: any[]) => any;
    max: (...args: any[]) => any;
